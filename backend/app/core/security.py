...
def create_access_token(subject: Any, expires_delta: timedelta | None = None) -> str:
    ...
    Args:
        subject: L'identifiant du sujet (ex: user id).
        expires_delta: Durée de vie du token. Utilise la config par défaut si None.
    """
...
def decode_access_token(token: str) -> str | None:
    """
    Décode un token JWT et retourne le subject (user id).
