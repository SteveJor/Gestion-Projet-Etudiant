      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <p className="text-md text-muted-foreground mt-0.5">
            {data
                ? `${data.total} projet${data.total !== 1 ? "s" : ""} ouvert${data.total !== 1 ? "s" : ""}`
                : "Chargement..."}
          </p>
        </div>
        ...
        {hasFilters && (
            <div className="flex flex-wrap gap-2">
              ...
              {domain && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 text-amber-800 text-md px-3 py-1 font-medium">
              {domain}
                    <button
                        onClick={() => {
                          setDomain("");
